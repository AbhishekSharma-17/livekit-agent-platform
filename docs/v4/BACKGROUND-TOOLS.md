...
| `silent_reply` (realtime) | Mutually exclusive with non-blocking modes (validator error). | D-V4-32 |
| Flows | Activity-scoped; transitions cancel cancellable background tools; 1.8.3 gate. A batch that hands off gets no reply from the draining node (below). | D-V4-37; R-V4-64 |
