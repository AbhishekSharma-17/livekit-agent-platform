...
| `openai-realtime` | gpt-realtime text $4 / cached $0.40 / $16, audio $32 / $64; gpt-realtime-mini text $0.60 / $0.06 / $2.40, audio $10 / $20 | same | matches (the page now leads with gpt-realtime-2.1, ask #135) |
...
| `deepgram-stt`, `deepgram-tts` | nova-3 $0.0048/min; flux-general-en $0.0065/min; Aura-2 $0.030/1k; Aura-1 $0.015/1k | deepgram.com/pricing | streaming figures are a **limited-time promotion** (regular $0.0077/min, ask #133); Nova-2 no longer in the rate table (left out) |
...
Not added: turn-detector / VAD "included" rows (the page shows an icon, not the word, ask #136); `nova-3-multi` (no registry id).
